...
import { MoreHorizontal, FileDown, Loader2, Search, X, Eye, Ban, CheckCircle, Users } from 'lucide-react';
                    ...
                    <TableRow>
                      <TableCell colSpan={5} className="h-24 text-center">
                        <div className="flex flex-col items-center justify-center gap-2">
                          ...
                          <p className="text-xs text-muted-foreground">There are no customers to display at this time.</p>
                        </div>
                      </TableCell>
                    </TableRow>
                  ) : (
